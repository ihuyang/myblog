...
<br>
>　　前段时间，我在工作中再次遇到编码问题，尽管最后解决，但还是让我决心通过查阅资料去好好研究编码问题。在本文中，我将针对这段时间自己对Java开发中编码问题的研究进行介绍，也算是自己的小结。篇幅原因，这部分内容将分成两篇文章，包括本文和《Java开发中的编码研究（2）——Java Web中的编解码》【待发布】，分别介绍编码基础以及编码在Web中的应用，你可以根据自己的兴趣顺序阅读，或者选择阅读。
...
<br>
>原文地址：[胡杨的个人博客-《Java开发中的编码研究（1）——编码概念》（2016.10.06）](http://ihuyang.me/java/web/Research-on-coding-in-java-development.html)